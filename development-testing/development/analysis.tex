...
\begin{figure}[H]
    ...
    \caption{TTGO T-Display ESP32 board dimensions \cite{esp32ttgo_product}}
...
\begin{itemize}
    ...
    \item The 1.14-inch ST7789V TFT display with a resolution of 240$\times$135 pixels
    \item The USB-C charging interface
    \item The JST 2-pin LiPo connector
\end{itemize}

\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{development-testing/development/image/esp32ttgo_specification.png}
    \caption{TTGO T-Display ESP32 board specifications \cite{esp32ttgo_product}}
